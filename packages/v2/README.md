...
Beta package for OpenCode 2. It targets `@opencode-ai/cli@0.0.0-next-15800` and uses the same `.opencode/command-hooks.jsonc` and agent frontmatter configuration as the V1 package.
